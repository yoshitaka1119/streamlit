...
if option == 'データ分析':
    ...
    if uploaded_file is not None:
        ...
        hist = alt.Chart(df, title='いいね数の傾向').mark_bar().encode(
            alt.X('いいね', bin=alt.Bin(
                extent=[0, df['いいね'].max()], step=4), title='いいね数'),
